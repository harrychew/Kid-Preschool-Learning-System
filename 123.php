                ...
                <div class="row">
                    <div class="span2">
                        <div class="content">
                           <?php
                            for ($i=1;$i<=14;$i++){
                            echo "<img src='images/sidebar14.jpg' width='500' height='500' alt='123'>";
                        }
                            ?> 
                        ...
                        <div class="content2">
                            ...
                            <table align ="center" border="1" style="font-size:125%; color:black; border-color:black;">
                                <tr align="center" style="font-size:125%;color:black">
                                    <th>&nbsp&nbsp Number&nbsp&nbsp  </th>
                                    <th> &nbsp&nbsp Words &nbsp&nbsp </th>
                               ...
                               $list2=array("zero","one","two","three","four","five","six","seven","eight","nine","ten"); 
                               for ($x=0;$x<=10;$x++){
                               echo "<tr align='center' style='font-size:125%;color:black'>
                                    <td>".$list[$x]."</td><td>".$list2[$x]."
                                    </td><td><br><br><audio controls>
                            ...
                            <br><br>
                            <h2 align="center" style="font-size:300%;color:black">Did you get it right?</h2>
                            <p style="text-align:left;font-size:150%;color:black">
                            <a href="abc.php" style="color:black">Learn ABC!</a>
